...
public class Sorter {  // begin class
...
*/
    ...
    // ************************ processing ***************************
        System.out.println("Using Selection Sort to Sort Array");
    System.out.println("printing unsorted list");
    af.loadList(list);
    af.printList(list,20);
    
    System.out.println("printing sorted list");
    af.selectionSort(list);
    
    af.printList(list,20);
 
 System.out.println("Using Bubble Sort to Sort Array");
 System.out.println("printing unsorted list");
    af.loadList(list);
    af.printList(list,20);
